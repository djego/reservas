...
<div class="contenido-izq">
	...
	<div class="hotel-listado">
			<div class="hotel-listado-foto"><a title="<?php echo $hotel['name']; ?>" href="#"><img src="<?php echo $hotel['sphoto']; ?>" width="100" height="75"></a>
			</div>
			<div class="hotel-listado-info">
				...
				<div class="hotel-precio">desde <span><?php echo round($hotel['minrate']);?> &#8364;</span><br />
						...
						<div class="hotel-titulo"><a title="<?php echo $hotel['name']; ?>" href="http://www.andorrahoteles.com"><?php echo $hotel['name']; ?></a> <img src="images/<?php echo $hotel['class_and'];?>-hotel-estrellas.png" alt="<?php echo $hotel['start'];?> estrellas" />
						<br />
