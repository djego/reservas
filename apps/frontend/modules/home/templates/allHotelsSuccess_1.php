...
Más de 1.100 <strong>Hoteles en París al mejor precio GARANTIZADO!</strong>
  ...
  <a href="http://www.parishoteles.net/audioguias-de-paris/" title="Audioguias de Paris">
    <embed width="468" height="60" src="<?php echo sfConfig::get('app_s_img')?>paris-468x60.swf?clickTAG=http://www.parishoteles.net/audioguias-de-paris/"/>
  </a>
    ...
    <div class="home-under">
      ...
      <div class="home-content2">
        <div class="navegacion">
          <a href="<?php echo url_for('homepage'); ?>" title="Hoteles en Pais">Andorra Hoteles</a> > Todos los hoteles</div>
