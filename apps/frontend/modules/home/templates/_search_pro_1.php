  ...
  <dt>Filtrar por estrellas</dt>
    ...
    <dd>
      ...
      <label for="star_1"><img src="<?php echo sfConfig::get('app_s_img'); ?>1-hotel-estrellas.png" alt="1 estrella" width="66" height="12" /></label>
    </dd>
    <dd>
      <input <?php echo  $star_sesion['star_2']?'checked="checked"':''; ?>  id="star_2" type="checkbox" name="star_2" value="2" />
      <label for="star_2"><img src="<?php echo sfConfig::get('app_s_img'); ?>2-hotel-estrellas.png" alt="1 estrella" width="66" height="12" /></label>
    </dd>
    <dd>
      <input <?php echo  $star_sesion['star_3']?'checked="checked"':''; ?>  id="star_3" type="checkbox" name="star_3" value="3" />
      <label for="star_3"><img src="<?php echo sfConfig::get('app_s_img'); ?>3-hotel-estrellas.png" alt="1 estrella" width="66" height="12" />3 estrella</label>
    </dd>
    <dd>
      <input <?php echo  $star_sesion['star_4']?'checked="checked"':''; ?>  id="star_4" type="checkbox" name="star_4" value="4" />
      <label for="star_4"><img src="<?php echo sfConfig::get('app_s_img'); ?>4-hotel-estrellas.png" alt="1 estrella" width="66" height="12" />4 estrellas</label>
    </dd>
    <dd>
      <input <?php echo  $star_sesion['star_5']?'checked="checked"':''; ?>  id="star_5" type="checkbox" name="star_5" value="5" />
      <label for="star_5"><img src="<?php echo sfConfig::get('app_s_img'); ?>5-hotel-estrellas.png" alt="1 estrella" width="66" height="12" />5 estrella</label>
    </dd>
