        ...
        <div class="listados-drcha">
          ...
          <div align="center"><br />
            <div class="paginacion">
              ...
              <a href="<?php echo url_for('hotels_result', array('id' => $rs_city['id'], 'slug' => 'paris')) ?>?p=<?php echo $pager->getPreviousPage() ?>" title="P&aacute;gina anterior">
                &lt; Anterior
              </a>
                <?php endif; ?>
              ...
              <span class="current"><strong><?php echo $page ?></strong></span>
                  <?php else: ?>
              <a href="<?php echo url_for('hotels_result', array('id' => $rs_city['id'], 'slug' => 'paris')) ?>?p=<?php echo $page ?>" title="Pagina <?php echo $page ?> de hoteles" ><?php echo $page ?></a>
                  <?php endif; ?>
                <?php endforeach; ?>
                <?php if (!$pager->isLastPage()):?>
              <a href="<?php echo url_for('hotels_result', array('id' => $rs_city['id'], 'slug' => 'paris')) ?>?p=<?php echo $pager->getNextPage() ?>" title="P&aacute;gina siguiente">Siguiente &gt;</a>
                <?php endif; ?>
              <?php endif; ?>
            </div>
          </div>
