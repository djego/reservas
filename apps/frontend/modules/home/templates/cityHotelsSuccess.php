...
<dl class="refine">
	...
	<dd class="check-all"><input type="checkbox" name="person_all"
		id="person_all" checked="checked" value="all" /><label
		for="person_all">Todo</label> <span class="counter"
		id="person_all_count"></span></dd>
...
resultados por:&nbsp;</span> <select class="comboAvanzadas"
	onchange="window.location.replace(this.value)" name="orden">
...
<!---anuncio hotel--> <?php foreach($lst_hotel as $hotel):?>
<div class="listados-hoteles">
<div class="listados-hoteles-foto">
	<a title="<?php echo $hotel['name']; ?>" href="http://www.andorrahoteles.com"> 
...
<div class="listados-hoteles-precio"><b>valoraci&oacute;n</b> <span>9</span><br />
80 opiniones<br />
...
<a title="<?php echo $hotel['name']; ?>"
	href="http://www.andorrahoteles.com"><img
	src="<?php echo sfConfig::get('app_s_img')?>precios-hotel.png"
	alt="Precios de Hotel Mena Andorra" border="0" /></a></div>
<div class="listados-hoteles-titulo"><a
	title="<?php echo $hotel['name']; ?>"
	href="http://www.andorrahoteles.com"><?php echo $hotel['name']?></a> <img
	src="<?php echo sfConfig::get('app_s_img').$hotel['class_and']?>-hotel-estrellas.png"
	alt="<?php echo $hotel['class_and']?> estrellas" /> <br />
<em><?php echo $hotel['address']; ?>, <?php echo $hotel['city']; ?></em>
- <span><a title="ver mapa" href="<?php echo url_for('mapa');?>?la=<?php echo $hotel['latitude'];?>&lo=<?php echo $hotel['longitude'];?>">ver
mapa</a><span></div>
<div class="listados-hoteles-descripcion"><?php  $desc = substr($hotel['description'],0,200);								      						
echo substr($hotel['description'],0,strripos($desc,' '))?>... <a
	href="http://www.andorrahoteles.com">M&aacute;s informaci&oacute;n</a></div>
</div>
</div>
</div>
<?php endforeach;?>
