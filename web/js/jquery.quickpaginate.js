...
jQuery.fn.quickpaginate = function( settings ) {
	...
	var setNav = function()
	{
		...
		var pagerNav = $('<span  style="height:18px;display:inline-block;cursor:pointer;width:60px;font:11px tahoma;text-align:center;" class="'+settings.prev+' paginacion first ui-corner-tl ui-corner-bl fg-button ui-state-default" alt="Anterior" title="Anterior" > Anterior </span>'+ 
						 '<span  style="height:18px;display:inline-block;cursor:pointer;width:60px;font:11px tahoma;text-align:center;" class="'+settings.next+' paginacion last ui-corner-tr ui-corner-br fg-button ui-state-default" alt="Siguiente" title="Siguiente"> Siguiente </span>');
		
		jQuery(settings.pager).append( pagerNav );
		
		if ( settings.showcounter )
		{
			var counter = '<span class="'+settings.counter+' ui-state-default" style="text-align:center;height:18px;width:80px;display:inline-block;font:11px tahoma" ><span class="'+settings.pagenumber+'"></span> de <span class="'+settings.totalnumber+'"></span></span>';
