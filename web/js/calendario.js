...
function pickDate(y,m,d,dt,frm){var f=calendar.calf;var dt=calendar.caldt;f[dt+'_month'].value=y+"-"+m;f[dt+'_day'].value=d;if(dt=="search_fecha-inicio"){checkDateOrder(calendar.calfrm,'search_fecha-inicio_day','search_fecha-inicio_month','search_fecha-final_day','search_fecha-final_month');}
if(dt=="dispo_fecha-inicio"){checkDateOrder(calendar.calfrm,'dispo_fecha-inicio_day','dispo_fecha-inicio_month','dispo_fecha-final_day','dispo_fecha-final_month');}
closeCal();}
