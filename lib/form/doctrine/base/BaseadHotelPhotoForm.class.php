...
/**
 * adHotelPhoto form base class.
 *
 * @method adHotelPhoto getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseadHotelPhotoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ad_hotel_photo[%s]');
