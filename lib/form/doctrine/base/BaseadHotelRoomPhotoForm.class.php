...
/**
 * adHotelRoomPhoto form base class.
 *
 * @method adHotelRoomPhoto getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseadHotelRoomPhotoForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('ad_hotel_room_photo[%s]');
